...
<script setup lang="ts">
  ...
  import transformType from 'src/libs/transform/typescript/type'
  import transformRest from 'src/libs/transform/typescript/rest'
  ...
  const changed = async (value: string, kind?: any) => {
    ...
    const transform = (kind ?? route.query.kind) === 'type' ? transformType : transformRest
