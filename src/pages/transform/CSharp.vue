<template>
  <q-splitter v-bind:model-value="50">
    ...
    <template v-slot:after>
      <div class="q-pa-md">
        <q-toolbar class="text-primary">
          <q-toolbar-title>C#</q-toolbar-title>
      ...
      <q-card-section>
        <q-form>
          ...
          <q-item-label>
            ...
            <q-checkbox v-model="options.useClrType" label="use CLR type" />
          </q-item-label>
        </q-form>
        <q-form>
          <q-item-label header>Json.Net</q-item-label>
          <q-item-label>
            <q-checkbox v-model="options.useJsonProperty" label="Add JsonProperty" />
            <q-checkbox v-model="options.useCamelCasePropertyNamesContractResolver"
                        label="use CamelCasePropertyNamesContractResolver" />
          </q-item-label>
        </q-form>
        <q-form>
          <q-item-label header>System.Text.Json</q-item-label>
          <q-item-label>
            <q-checkbox v-model="options.useJsonPropertyName" label="use JsonPropertyName" />
            <q-checkbox v-model="options.useCamelCaseJsonNamingPolicy" label="use JsonNamingPolicy.CamelCase" />
          </q-item-label>
        </q-form>
      </q-card-section>
    </q-card>
...
<script setup lang="ts">
  ...
  import transform from 'src/libs/transform/csharp'
